---
name: green
description: Implement the minimal production code to make the currently failing test(s) pass — the green step of TDD, companion to /red. Use when the user says "/green", "make it pass", or wants the feature implemented for a red test without touching the test itself.
---
